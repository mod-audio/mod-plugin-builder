...
FOMP_LABS_BUNDLES = fomp-labs.lv2
...
define FOMP_LABS_INSTALL_TARGET_CMDS
	...
	mv $(TARGET_DIR)/usr/lib/lv2/fomp.lv2 $(TARGET_DIR)/usr/lib/lv2/fomp-labs.lv2
	cp -rL $($(PKG)_PKGDIR)/fomp-labs.lv2/* $(TARGET_DIR)/usr/lib/lv2/fomp-labs.lv2/
endef
