...
DPF_PLUGINS_LABS_VERSION = 0e92714525c0334908a0eb79d6760e06316c2148
...
DPF_PLUGINS_LABS_TARGET_MAKE = $(TARGET_MAKE_ENV) $(TARGET_CONFIGURE_OPTS) $(MAKE) CROSS_COMPILING=true NOOPT=true HAVE_CAIRO=false HAVE_GL=false -C $(@D)
