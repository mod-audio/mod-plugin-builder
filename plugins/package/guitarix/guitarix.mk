...
GUITARIX_SITE = git://git.code.sf.net/p/guitarix/git
GUITARIX_SITE_METHOD = git
GUITARIX_DEPENDENCIES = boost eigen fftwf glibmm libsndfile zita-convolver zita-resampler host-python host-intltool
