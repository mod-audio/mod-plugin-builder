...
CHOW_CENTAUR_DEPENDENCIES = juce
CHOW_CENTAUR_CONF_OPTS = -DCMAKE_TOOLCHAIN_FILE=$(BR2_EXTERNAL)/../plugins-dep/package/juce/toolchainfile.cmake -DSKIP_LV2_TTL_GENERATOR=ON
