...
REMAINCALM_PLUGINS_TARGET_MAKE = $(TARGET_MAKE_ENV) $(TARGET_CONFIGURE_OPTS) $(MAKE) NOOPT=true lv2_ttl= CPPFLAGS="-DDISTRHO_PLUGIN_USES_CUSTOM_MODGUI=1 -DSTATIC_BUILD=1"
