...
define X42_PLUGINS_INSTALL_TARGET_CMDS
	...
	cp -rL $(BR2_EXTERNAL)/package/x42-plugins/balance.lv2/*    $(TARGET_DIR)/usr/lib/lv2/balance.lv2/
	cp -rL $(BR2_EXTERNAL)/package/x42-plugins/convo.lv2/*      $(TARGET_DIR)/usr/lib/lv2/convo.lv2/
	cp -rL $(BR2_EXTERNAL)/package/x42-plugins/midifilter.lv2/* $(TARGET_DIR)/usr/lib/lv2/midifilter.lv2/
	cp -rL $(BR2_EXTERNAL)/package/x42-plugins/nodelay.lv2/*    $(TARGET_DIR)/usr/lib/lv2/nodelay.lv2/
	cp -rL $(BR2_EXTERNAL)/package/x42-plugins/xfade.lv2/*      $(TARGET_DIR)/usr/lib/lv2/xfade.lv2/
endef
